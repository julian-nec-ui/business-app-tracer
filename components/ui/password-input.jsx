  ...
  return (
    <PasswordInputContext value={{ password: currentValue.toString() }}>
      <div className="space-y-3">
        <InputGroup className={background}>
          <InputGroupInput
          className="w-88"
            {...props}
            value={value}
            ...
            onChange={handleChange} placeholder={props.placeholder || "password"}   />
          <InputGroupAddon>
            <InputGroupButton className="w-6 h-6 absolute top-3/6 transform -translate-y-1/2 right-2" onClick={() => setShowPassword(!showPassword)}>
